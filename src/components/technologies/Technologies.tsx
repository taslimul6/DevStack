...
export default function Technologies() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-10">
            <h2 className= "text-3xl sm:text-4xl md:text-5xl font-bold"> Explore The<span className="bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 bg-clip-text text-transparent">Technologies</span>
            </h2>
            <p className="mt-5 text-sm sm:text-base text-gray-500">Pick one technology per category to build your ideal stack.</p>
